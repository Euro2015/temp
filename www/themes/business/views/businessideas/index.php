<p class="breadcrumb"><a href="index.php">Home</a>&#062 business ideas </p>
<div>
        <?php 
...
<div class="sign-up-tabss"> <!-- start sign up tab -->
      ...
      <div id="tabs_container">
            <ul id="sign-up-tabs">
                <li class="active">
                    <a href="#taba" title="Full list of ALL Business Ideas entries">Business ideas<br/>( 999,999,999 )</a>
                </li>
                <li>
