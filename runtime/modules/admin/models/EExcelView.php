<?php
	...
	*/	
	class EExcelView extends CGridView
	{
		...
		public $libPath = 'application.modules.admin.extensions.phpexcel.Classes.PHPExcel'; //the path to the PHP excel lib
		...
		public function run()
		{
			if($this->grid_mode == 'export')
			{
				...
				if(!$this->stream)
					$objWriter->save(Yii::app()->basePath.'/../www/upload/documents/'.$this->filename);
