...
<div id="tabs_container">
    <ul id="sign-up-tabs">
        <li class="active">
            <a href="#taba" title="Full list of ALL Business Ideas entries">Industrial<br/>( <?php echo $total_posts; ?> )</a>
        </li>
        <li>
    ...
    <table border="0" bordercolor="#fff" style="background-color:#fff; cursor:pointer" width="100%" cellpadding="1" cellspacing="2">
        <tr class="tableHeading">
            ...
            <td>
                ...
                echo CHtml::dropDownList('drg_lookfor','',$listData1,array('style'=>'width:100px','empty' => '','class'=>'chzn-select','data-placeholder'=>'Looking for','id'=>'sl_lookfor','tabindex'=>'2', 'onchange' => "window.location = '?looking_for='+$(this).val();"));?>
            </td> <!-- Looking for... -->
            <td>
...
<?php $posts_per_page=isset($_REQUEST['rows'])?$_REQUEST['rows']:12;$count=0; if($posts) {foreach ($posts as $post) {if($count%2==0){$color='Grey';}else{$color='Mauve';}?>       <tr onmouseover="ChangeColor<?php echo $color; ?>(this, true);" 
                ...
                class="<?php echo $color; ?>Row">
                    <td><?php echo date('d/m/y',strtotime($post->drg_approvedate));?></td>
                    <td><?php echo $post->drg_title;?></td>
                    <td><?php echo $post->drg_desc;?></td>
                    <td><?php echo Listinglookingfor::model()->getRowTitle($post->drg_profession);?></td>
                    <td><?php echo Country::model()->getRowTitle($post->drg_viewlimit);?></td>
                </tr>
    ...
    <table border="0" bordercolor="#fff" style="background-color:#fff; cursor:pointer" width="100%" cellpadding="1" cellspacing="2">
        ...
        <?php $posts_per_page=isset($_REQUEST['rows'])?$_REQUEST['rows']:12;$count=0; if($fav_posts) {foreach ($fav_posts as $post) {if($count%2==0){$color='Grey';}else{$color='Mauve';}?>
            <tr onmouseover="ChangeColor<?php echo $color; ?>(this, true);"
                ...
                <td width="140px"><?php echo $post->drg_title;?></td>
