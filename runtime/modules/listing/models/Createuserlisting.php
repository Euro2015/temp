 ...
 */
class Createuserlisting extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			//array('drg_company_address1,drg_company_town,drg_company_county,drg_company_zip_code,drg_company_tel_no', 'required'),
			...
			array('drg_category, drg_profession, drg_viewlimit, drg_date, drg_datetime, drg_status,  drg_company_name, drg_company_zip_code', 'length', 'max'=>50),
