<div id="shadow-wrap">
  ...
  <div id="leftcontent"> <!-- slider-wrapper start -->
    <?php //$template->get('slider'); ?>
    <!-- Loads home slider -->  
    
    <p class="breadcrumb"><a href="index.php">Home</a>&#062 industrial</p>
    <div>
        <?php 
            $this->renderPartial('//layouts/listing_slider');
        ?>    
    </div>
    <!--start advertiser carousel----->        
    <?php $drg_lookfor = ""; ?>
    <!-- /end advertiser carousel -->
           
    <!--start generic buttons----->        
    <?php //$modules->get('generic_buttons'); ?>
    <!-- /end advertiser carousel -->
    ...
    <div class="sign-up-tabss"> <!-- start sign up tab -->
      ...
      <div id="tabs_container">
            <ul id="sign-up-tabs">
                <li class="active">
                    <a href="#taba" title="Full list of ALL Industrial Ideas entries">Industrial<br/>( 999,999,999 )</a>
                </li>
                <li>
